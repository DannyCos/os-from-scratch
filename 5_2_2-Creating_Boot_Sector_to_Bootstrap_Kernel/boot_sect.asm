...
KERNEL_OFFSET equ 0x1000    ; This is the memory offset to which we will load our kernel
    ...
    call switch_to_pm       ; Switch to protected mdoe, from which we will not return

    jmp $

; Include our previously written routines
...
BEGIN_PM:
    mov ebx, MSG_PROT_MODE  ; Use our 32-bit print routine to announce we are in protected mode
